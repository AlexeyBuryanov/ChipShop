...
<div id="header_bg">
    <div class="container">
        <div class="head-t">
            <!-- Лого -->
            <div class="logo"><a href="../main/index.php"><h1>Mag<span>Buy</span></h1></a></div>
            <a href="../main/index.php"><img id="errorImg" src="../../web/assets/images/error_400.jpg"></a>
        </div>
    </div>
</div>
